          ...
          <div class="container-fluid">
            ...
            <form class="user" method="post" action="">
              ...
              ?>
                ...
                <div class="row">
                  <div class="col-4 mb-3">Staff Code </div>
                ...
                <div class="row">
                  <div class="col-4 mb-3">Staff Dept</div>
                  <div class="col-8 mb-3">
                ...
                <div class="row">
                  <div class="col-4 mb-3">Staff Desigantion</div>
                ...
                <div class="row">
                  <div class="col-4 mb-3">Staff Contact No.</div>
                  <div class="col-8 mb-3">
                ...
                <div class="row">
                  <div class="col-4 mb-3">Staff Joing Date(yyyy-mm-dd)</div>
                  <div class="col-8  mb-3">
